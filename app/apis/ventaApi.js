...
const {buscar,listar,listarDetalle,listarInicio, crear, editar, editarPago, buscarDetalle, crearDetalle,editarDetalle, eliminarDetalle, listarPago, pagar, buscarPago,eliminarPago, eliminar, documento, buscarTotales,clave} = require('../controllers/ventaControllers');
...
router.put('/api/venta/editar/pago/:id', caracter, verificarToken, editarPago);
